...
Uses Windows WASAPI loopback via PyAudioWPatch. Captures the default output
device (e.g. browser playing an online course). Requires:
  - Windows
...
class InternalAudioRecorder:
    """
    Record internal (system) audio via WASAPI loopback.
